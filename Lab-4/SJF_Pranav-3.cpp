...
int main(int argc, char *argv[]){
    ...
    for(auto p: process){
        ...
        cout<<"Process "<<p.pid<<" completion time: "<<p.completion_time<<" arrival time: "<<p.arrival_time<<" waiting time: "<<p.waiting_time<<" turnaround time: "<<p.turnaround_time<<" response time: "<<p.response_time<<"\n";
    }
