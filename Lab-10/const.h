...
// Assignment-10
// I_IMMEDIATE is not used in the kernel, but it is used in the user space. 
// So, we need to define it here.
// The significance of the value 0110000 is that it is the same as the value of I_SYMBOLIC_LINK.
